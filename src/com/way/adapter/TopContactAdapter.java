...
public class TopContactAdapter extends SimpleCursorAdapter{
	...
	private static final String[] ROSTER_QUERY = new String[] {
		...
		RosterConstants.STATUS_MODE, RosterConstants.TOP, RosterConstants.STATUS_MESSAGE, };	
	...
	public void requery() {
		...
		Cursor cursor = mContentResolver.query(RosterProvider.CONTENT_URI,
				ROSTER_QUERY, RosterProvider.RosterConstants.TOP + "=?", new String[]{RosterProvider.TOP_YES}, RosterConstants.ALIAS);
	...
	public int getCount() {
		...
		L.d("lzctest","lzctest->topcontactadapter->getCount:"+super.getCount());
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		L.d("lzctest","lzctest->topcontactadapter->getView");
...
//		cursor.close();
	...
	protected void setViewImage(ImageView online, ImageView head, ImageView v,
		...
		if (statusDrawable == -1) {
			...
			head.setImageResource(R.drawable.login_default_jabber_offline);
			online.setImageDrawable(null);
			return;
		}
		head.setImageResource(R.drawable.login_default_jabber);
	...
	public class Roster {
		...
		public String toString() {
			// TODO Auto-generated method stub
			return jid+alias+statusMode+statusMessage;
		}
	...
	public Roster getRoster(int position) {
		...
		// that group
		L.d("lzctest","lzctest->topcontactadapter->getRoster");
